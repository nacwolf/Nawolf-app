...
export const CreateSkuBody = zod.object({
  ...
  netWeightUnit: zod.string().nullish(),
  grossWeight: zod.number().nullish(),
  grossWeightUnit: zod.string().nullish(),
  unitsPerCarton: zod.number().int().nullish(),
  cartonGrossWeight: zod.number().nullish(),
  cartonGrossWeightUnit: zod.string().nullish(),
  cartonDimL: zod.number().nullish(),
  cartonDimW: zod.number().nullish(),
  cartonDimH: zod.number().nullish(),
  shelfLife: zod.number().int().nullish(),
  shelfLifeUnit: zod.string().nullish(),
  storageCondition: zod.string().nullish(),
  // Section III
  exFactoryPrice: zod.number().nullish(),
  fobPrice: zod.number().nullish(),
  moq: zod.number().int().nullish(),
  moqUnit: zod.string().nullish(),
  // Section IV
  fdaNumber: zod.string().nullish(),
  barcodeEan13: zod.string().nullish(),
  halalCertified: zod.boolean().optional(),
  gmpCertified: zod.boolean().optional(),
  haccpCertified: zod.boolean().optional(),
...
export const UpdateSkuBody = zod.object({
  ...
  fdaNumber: zod.string().nullish(),
  barcodeEan13: zod.string().nullish(),
  halalCertified: zod.boolean().nullish(),
  gmpCertified: zod.boolean().nullish(),
